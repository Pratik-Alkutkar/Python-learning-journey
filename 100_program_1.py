...
@Goal: 
    To take a list of integers from end user 
    and compare every number in list with every 
    other number but not with itself and print 
...
def prn_all_comparisons(L:list)->None: 
    """
    compare every number in list with every 
    other number but not with itself and print 
    the result of comparison. 
    """
